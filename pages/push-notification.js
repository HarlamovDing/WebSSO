      ...
      <div className="content__push">
        <div className="content__push-left">
          <p className="description">
            ...
            the <a target={"_blank"} href="https://play.google.com/store/games?hl=ru&gl=US">Defispace App</a>
          </p>
        ...
        <div className="content__push-right">
          <div className="content__push--logo">
            <Image width={"50px"} height="50px" src={"/LogoIcon.svg"}></Image>
          </div>
        </div>
      </div>
      ...
      <div className="content__btns">
        ...
        >
          <a className="btn btn--image btn--white">
            No Defispace App
            <Image width={20} height={20} src={'/information.svg'}/>
          </a>
        </Link>
      </div>
